...
if (isset($_SESSION['loger']) && $_SESSION['loger'] == true && $_SESSION['username']=='administrador') {

} else {
    echo "<script>alert('Tienes que iniciar sesion para entrar al sitio o no tienes el permiso suficiente.') </script>";
